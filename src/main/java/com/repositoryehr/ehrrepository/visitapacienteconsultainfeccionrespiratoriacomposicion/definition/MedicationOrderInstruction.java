...
public class MedicationOrderInstruction implements EntryEntity {
  /**
   * Path: Visita Paciente consulta infección respiratoria/Medication order/Order
  ...
  /**
   * Path: Visita Paciente consulta infección respiratoria/Medication order/Extension
  ...
  /**
   * Path: Visita Paciente consulta infección respiratoria/Medication order/subject
   */
  @Path("/subject")
  private PartyProxy subject;

  /**
   * Path: Visita Paciente consulta infección respiratoria/Medication order/narrative
   */
  @Path("/narrative|value")
  private String narrativeValue;

  /**
   * Path: Visita Paciente consulta infección respiratoria/Medication order/language
   */
  @Path("/language")
  private Language language;

  /**
   * Path: Visita Paciente consulta infección respiratoria/Medication order/feeder_audit
   */
  @Path("/feeder_audit")
  private FeederAudit feederAudit;

  /**
   * Path: Visita Paciente consulta infección respiratoria/Medication order/expiry_time
   */
